    ...
    def forward(self, images, explanations, scores):
        ...
        if RunningParams.k_value == 1:
            ...
            for sample_idx in range(RunningParams.k_value):
                ...
                explanation_feat = self.pooling_layer(explanation_spatial_feat).squeeze()
            ...
            explanation_feats = torch.stack(explanation_feats, dim=1)
            explanation_feat = explanation_feats.flatten(start_dim=1)
