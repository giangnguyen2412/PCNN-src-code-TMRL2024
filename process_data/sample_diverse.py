...
train_folder = f'{RunningParams.parent_dir}/RN50_dataset_CUB_HP/train'
val_folder = f'{RunningParams.parent_dir}/RN50_dataset_CUB_HP/val'
test_folder = f'{RunningParams.parent_dir}/RN50_dataset_CUB_HP/test'
