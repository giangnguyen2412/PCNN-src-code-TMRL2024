...
folder_path = "/home/giang/Downloads/advising_network/stanford-dogs/data/images/validation_top2"
dict_path = "/home/giang/Downloads/advising_network/faiss/sdogs/top2_k1_enriched_NeurIPS_Finetuning_faiss_validation.npy"
...
for root, dirs, files in os.walk(folder_path):
    for file in files:
        ...
        # if file.lower().endswith(".jpeg"):
            ...
            for i in range(2):
                if i == 0:
                    for j in range(1):  # Make up 5 NN sets from top-1 predictions
